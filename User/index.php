            ...
            <div class="grid">
                <nav class="header__navbar"> 
                    <ul class="header__navbar-list">
                        ...
                        <li class="header__navbar-item">
                            Ghé fanpage
                            <a href="./Sign-in.html" class="header__navbar-icon-link">
                    ...
                    <ul class="header__navbar-list">
                        <li class="header__navbar-item">
                            ...
                            <a href="./Sign-in.html" class="header__navbar-item-link">Thông báo</a>
                        </li>
                        <li class="header__navbar-item">
                            <i class="fa-regular fa-circle-question"></i>
                            <a href="./Sign-in.html" class="header__navbar-item-link">Trợ giúp</a>
                        </li>
                        <li class="header__navbar-item ">
                            <a href="./Sign-up.html" class="header__navbar-item-link">Đăng ký</a>
                        </li>
                        <li class="header__navbar-item">
                            <a href="./Sign-in.html" class="header__navbar-item-link">Đăng nhập</a>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="header-with-search" >
                    ...
                    <div class="header__search">
                        <input type="text" id="inputField" class="header__search-input" onclick="indexClick()" placeholder="Nhập để tìm kiếm sản phẩm">
                        ...
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                <li class="category-item category-item__active">
                                    <a href="./Sign-in.html" class="category-item__link">Trang chủ</a>
                                </li>
                                <li class="category-item">
                                    <a href="./Sign-in.html" class="category-item__link">Sữa tăng cân</a>
                                </li>
                                <li class="category-item">
                                    <a href="./Sign-in.html" class="category-item__link">Whey Protein</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <div class="home-filter">
                            ...
                            <div class="home-filter__page">
                                ...
                                <div class="home-filter__page-control">
                                    <a href="./Sign-in.html" class="home-filter__page-btn home-filter__page-btn--disabled">
                                        <i class="home-filter__page-icon fa-solid fa-angle-left"></i>
                                    </a>
                                    <a href="./Sign-in.html" class="home-filter__page-btn">
                        ...
                        <div class="home-product">
                            <div class="grid__row">
                                <div class="grid__column-2-4">
                                    <a class="home-product-item" href="./Sign-in.html">
                                ...
                                <div class="grid__column-2-4">
                                    <a class="home-product-item" href="./Sign-in.html">
                                        <div class="home-product-item__img">
                                            ...
                                            <div class="home-product-item__price">
                                                <span class="home-product-item__price-current"><b>1.700.000đ</b></span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class="grid__column-2-4">
                                    <a class="home-product-item" href="./Sign-in.html">
                                        <div class="home-product-item__img">
                                            ...
                                            <div class="home-product-item__price">
                                                <span class="home-product-item__price-current"><b>1.800.000đ</b></span>
                                            </div>
                                        </div>
                                    </a>
                                </div> 
            ...
            <div class="grid">
                <div class="grid__row">
                    <div class="grid__column-2-4">
                        ...
                        <ul class="footer-list">
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link">
                    ...
                    <div class="grid__column-2-4">
                        ...
                        <ul class="footer-list">
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link">Chính sách dữ liệu</a>
                            </li>
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link">Chính sách bảo mật</a>
                            </li>
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link">Chính sách kinh doanh</a>
                            </li>
                        </ul>
                    </div>
                    <div class="grid__column-2-4">
                        ...
                        <ul class="footer-list">
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link">Kiểm tra tích điểm</a>
                            </li>
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link">Hướng dẫn tập gym</a>
                            </li>
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link">Chế độ dinh dưỡng</a>
                            </li>
                        </ul>
                    </div>
                    <div class="grid__column-2-4">
                        ...
                        <ul class="footer-list">
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link">Tư vấn và đặt hàng: <br> 091.901.3030</a>
                            </li>
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link">Phục vụ tất cả các ngày trong tuần</a>
                            </li>
                            <li class="footer-item">     
                                <a href="./Sign-in.html" class="footer-item__link">Bắt đầu mở cửa bán hàng từ 8h30</a>
                            </li>
                        </ul>
                    </div>
                    <div class="grid__column-2-4">
                        ...
                        <ul class="footer-list">
                            ...
                            <li class="footer-item">
                                <a href="./Sign-in.html" class="footer-item__link"><img src="./Ảnh footer/IyxQtiu.png" alt="" class="footer-img"></a>
                            </li>
                        </ul>
                    </div>
                </div>

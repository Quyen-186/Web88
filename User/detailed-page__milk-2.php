            ...
            <div class="grid">
                <div class="grid__row app__content">
                    ...
                    <div class="grid__column-5">
                        <img src="./Ảnh sản phẩm chi tiết/Sữa tăng cân - Ảnh sp chi tiết/upl_elitelab_mass_muscle_gainer_20lbs_1670403426_image_1670403426.jpg"
                    ...
                    <div class="app__container-info-describtion">
                        ...
                        <div class="describtion-product">
                            ...
                            <p>
                                - 1350 calo khi không pha cùng sữa thực sự là một thách thức không nhỏ đối với các sản
                                phẩm cạnh tranh. Và với hàm lượng cao như vậy, tăng cân là chuyện tất yếu.
                                <br>
                                - Bên cạnh đó, sự kết hợp giữa Protein và BCAA hàm lượng cao có trong Up Your Mass XXXL
                                1350 giúp phục hồi cơ bắp nhanh chóng, đồng thời tăng tổng hợp protein . Khi tốc độ tổng
                                hợp > tốc độ phân hủy, dĩ nhiên, bạn sẽ có được sự phát triển cơ bắp.
                                <br>
                                - Up Your Mass XXXL 1350 chứa 11g axit amin chuỗi nhánh (đây là các axit amin thiết yếu
                                gồm Valine, Isoleucine và Leucine) =>> kích thích tổng hợp protein cơ bắp hơn loại
                                protein bình thường.
                                <br>
                                - Đặc biệt, khi sự bổ sung EAAs đang tạo nên một cơn sốt thực thụ trong làng gym thì khá
                                khen cho MHP đã rất thức thời trong cuộc đua dinh dưỡng này.
                            </p>
                        </div>
                    </div>
                </div>
